...
const I18N = {
  zh: {
    ...
    "moat.1.desc": "发明专利 · 国家知识产权局已受理。申请号 <code style=\"font-family:var(--mono);font-size:12px;color:var(--accent);\">202610208723.3</code>，申请日 2026-02-13，权利要求 10 项。",
    "moat.2.title": "基于物理环境元数据约束的水下图像生成式色彩还原方法及系统",
    "moat.2.desc": "发明专利 · 国家知识产权局已受理。申请号 <code style=\"font-family:var(--mono);font-size:12px;color:var(--accent);\">202610208686.6</code>，申请日 2026-02-12，权利要求 18 项。",
    "moat.3.title": "基于视控解耦双核架构的微型水下航行器电子系统",
    "moat.3.desc": "实用新型专利 · 国家知识产权局已受理。申请号 <code style=\"font-family:var(--mono);font-size:12px;color:var(--accent);\">202620215579.1</code>，申请日 2026-02-13，权利要求 10 项。",
    "moat.4.title": "集成轻量化水声模组及震动反馈机制的潜水电脑表",
    "moat.4.desc": "实用新型专利 · 交底书已完成，正在提交流程中。涵盖手环端 DYP-C01B 集成、IMU 翻腕 + 敲击识别、震动反馈闭环结构。",
    ...
    "meta.desc": "Project Remo 是一款无线、掌上起降的水下跟随相机。入水唤醒，声学定位跟随，出水无感回传，云端自动还原色彩。让潜水员专注于潜水本身。",
  ...
  en: {
    ...
    "compare.row.10.c3": "Lost Shot (Cloud Backup Recoverable)",
    ...
    "specs.int.10": "Immersion Wake / Seamless Upload",
    ...
    "moat.1.desc": "Invention patent · accepted by CNIPA. Application No. <code style=\"font-family:var(--mono);font-size:12px;color:var(--accent);\">202610208723.3</code>, filed 2026-02-13, 10 claims.",
    "moat.2.title": "Generative Underwater Color Restoration with Physical Environmental Metadata Constraints",
    "moat.2.desc": "Invention patent · accepted by CNIPA. Application No. <code style=\"font-family:var(--mono);font-size:12px;color:var(--accent);\">202610208686.6</code>, filed 2026-02-12, 18 claims.",
    "moat.3.title": "Vision-Control Decoupled Dual-Core Electronics Architecture for Micro AUV",
    "moat.3.desc": "Utility model patent · accepted by CNIPA. Application No. <code style=\"font-family:var(--mono);font-size:12px;color:var(--accent);\">202620215579.1</code>, filed 2026-02-13, 10 claims.",
    "moat.4.title": "Dive Computer Watch with Lightweight Acoustic Module &amp; Haptic Feedback",
    "moat.4.desc": "Utility model patent · disclosure complete, currently in the submission pipeline. Covers DYP-C01B integration, IMU wrist-flip + tap recognition, and haptic feedback loop structure on the bracelet end.",
